...
where date_entered_legacy_stage_refund_qualified IS NOT NULL 
AND date_entered_legacy_stage_initiated_document_upload IS NULL 
AND date_entered_legacy_stage_completed_document_upload IS NULL 
AND date_entered_legacy_stage_data_aggregation_started IS NULL 
AND date_entered_legacy_stage_data_aggregation_complete IS NULL 
AND date_entered_legacy_stage_docs_sent_to_cpa IS NULL 
AND date_entered_legacy_stage_cpa_created_invoice IS NULL 
AND date_entered_legacy_stage_invoice_signed IS NULL 
