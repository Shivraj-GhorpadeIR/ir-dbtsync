SELECT
    ...
    -- LEFT JOIN {{ ref('stg_hubspot_hp_association_type') }} a on c.company_id = a.from_id AND a.type = 'company_to_deal' and a.unlabeled = true
    ...
    -- LEFT JOIN {{ ref('stg_hubspot_hp_deal') }} d on d.id = a.to_id
